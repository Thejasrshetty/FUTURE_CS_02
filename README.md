...
-> Perform header authentication analysis  
-> Classify email risk level  
-> Create phishing awareness report  
...
- Analyzed sender, subject, and email content  
- Performed header analysis (SPF, DKIM, DMARC)  
